...
gaps:
  requirements: []
  integration:
    - "Mini-boss rare equipment (3 items) not sellable in shop — arguably intentional"
  flows: []
tech_debt:
...
| 6 | Phase 20→18: Mini-boss loot sellable | ⚠️ 0.5 | Equippable ✅, sellable ✗ (not in shop catalog) |
| 7 | Phase 17→19→20: Poison DoT system reuse | ✅ 1.0 | 3 consumers all use apply_poison() correctly |

**Integration Score: 6.5/7 (93%)**
